<%@ page import="by.shakhrai.epam.web.task.command.LocaleType" %>
       ...
       <div class="container-fluid">
        <div class="bd-example">
            ...
            <ul class="nav nav-pills">
                ...
                <c:if test="${userRole.equals('user')}">
                    <li class="nav-item">
                        <a class="nav-link" href="controller?command=USER_INFO_PAGE"><fmt:message key="profile" /></a>
                    </li>
                </c:if>
                ...
                <c:if test="${userRole.equals('admin')}">
                    <li class="nav-item">
                        <a class="nav-link" href="controller?command=ALL_USER_LIST"><fmt:message key="userList" /></a>
                    </li>
                </c:if>
